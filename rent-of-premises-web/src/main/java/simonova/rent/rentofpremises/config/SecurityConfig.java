...
/**
 * Конфигурационный класс, в котором определены настройки авторизации в приложении
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .csrf().disable()
                .authorizeRequests()
                .antMatchers("/","/register","/areas", "/applications", "/profile", "/areas/*/show", "/login/error/*","/areas/page/*","/sortByPriceDesc", "/sortByPriceAsc" ).permitAll()
                .anyRequest()
                .authenticated()
                .and()
                .formLogin()
