...
/**
 * Класс-модель помещений для передачи данных между представлением и базой данных
 */
public class PremisesDTO extends BaseDTO{
    ...
    /** Поле флаг для хранению отметки о том, арендовано помещение или нет*/
    private Boolean isRented;

    /** Поле для хранения изображения помещения*/
    ...
    public Set<ApplicationDTO> getApplications() {return applications;}

    public void setApplications(Set<ApplicationDTO> applications) {this.applications = applications;}
